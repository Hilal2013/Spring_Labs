...
public interface CartRepository extends JpaRepository<Cart,Long> {
    ...
    List<Cart> retrieveCartListByCustomer(@Param("id") Long id);
    ...
    List<Cart> findAllByCustomerIdAndCartStateAndDiscountIsNotNull(@Param("carState") String cartState, @Param("id") Long id);
}
